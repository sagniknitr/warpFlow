...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "source/warping_pyramid.h"
        ],
        "include_dirs": [
            "/usr/local/lib/python3.6/dist-packages/numpy/core/include"
        ],
        "language": "c++",
        "name": "optical_flow_warping",
        "sources": [
            "optical_flow_warping.pyx",
            "source/opticalflow_warping.cpp",
            "source/calc_optical_flow.cpp",
            "source/warping_pyramid.cpp",
            "source/gaussian_pyramid.cpp"
        ]
    },
    "module_name": "optical_flow_warping"
}
END: Cython Metadata */
...
#define __PYX_HAVE__optical_flow_warping
#define __PYX_HAVE_API__optical_flow_warping
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "source/warping_pyramid.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'optical_flow_warping' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "optical_flow_warping"
extern int __pyx_module_is_main_optical_flow_warping;
int __pyx_module_is_main_optical_flow_warping = 0;

/* Implementation of 'optical_flow_warping' */
...
static const char __pyx_k_optical_flow_warping[] = "optical_flow_warping";
static const char __pyx_k_optical_flow_warping_pyx[] = "optical_flow_warping.pyx";
...
static PyObject *__pyx_n_s_optical_flow_warping;
static PyObject *__pyx_kp_s_optical_flow_warping_pyx;
...
/* Python wrapper */
static PyObject *__pyx_pw_20optical_flow_warping_1coarse2fine_flow(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_20optical_flow_warping_coarse2fine_flow[] = "\n    Input Format:\n      double * vx, double * vy, double * warpI2,\n      const double * Im1 (range [0,1]), const double * Im2 (range [0,1]),\n      double alpha (1), double ratio (0.5), int minWidth (40),\n      int nOuterFPIterations (3), int nInnerFPIterations (1),\n      int nSORIterations (20),\n      int colType (0 or default:RGB, 1:GRAY)\n    Images Format: (h,w,c): float64: [0,1]\n    ";
static PyMethodDef __pyx_mdef_20optical_flow_warping_1coarse2fine_flow = {"coarse2fine_flow", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_20optical_flow_warping_1coarse2fine_flow, METH_VARARGS|METH_KEYWORDS, __pyx_doc_20optical_flow_warping_coarse2fine_flow};
static PyObject *__pyx_pw_20optical_flow_warping_1coarse2fine_flow(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("coarse2fine_flow (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Im2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("coarse2fine_flow", 0, 2, 9, 1); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "coarse2fine_flow") < 0)) __PYX_ERR(0, 18, __pyx_L3_error)
      }
    } else {
    ...
    if (values[2]) {
      __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    } else {
      __pyx_v_alpha = ((double)1.0);
    }
    if (values[3]) {
      __pyx_v_ratio = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_ratio == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    } else {
      __pyx_v_ratio = ((double)0.5);
    }
    if (values[4]) {
      __pyx_v_minWidth = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_minWidth == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    } else {
      __pyx_v_minWidth = ((int)40);
    }
    if (values[5]) {
      __pyx_v_nOuterFPIterations = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_nOuterFPIterations == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    } else {
      __pyx_v_nOuterFPIterations = ((int)3);
    }
    if (values[6]) {
      __pyx_v_nInnerFPIterations = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_nInnerFPIterations == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    } else {
      __pyx_v_nInnerFPIterations = ((int)1);
    }
    if (values[7]) {
      __pyx_v_nSORIterations = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_nSORIterations == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
    } else {
      __pyx_v_nSORIterations = ((int)20);
    }
    if (values[8]) {
      __pyx_v_colType = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_colType == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("coarse2fine_flow", 0, 2, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 18, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("optical_flow_warping.coarse2fine_flow", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_Im1), __pyx_ptype_5numpy_ndarray, 0, "Im1", 0))) __PYX_ERR(0, 18, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_Im2), __pyx_ptype_5numpy_ndarray, 0, "Im2", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_r = __pyx_pf_20optical_flow_warping_coarse2fine_flow(__pyx_self, __pyx_v_Im1, __pyx_v_Im2, __pyx_v_alpha, __pyx_v_ratio, __pyx_v_minWidth, __pyx_v_nOuterFPIterations, __pyx_v_nInnerFPIterations, __pyx_v_nSORIterations, __pyx_v_colType);
...
static PyObject *__pyx_pf_20optical_flow_warping_coarse2fine_flow(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_Im1, PyArrayObject *__pyx_v_Im2, double __pyx_v_alpha, double __pyx_v_ratio, int __pyx_v_minWidth, int __pyx_v_nOuterFPIterations, int __pyx_v_nInnerFPIterations, int __pyx_v_nSORIterations, int __pyx_v_colType) {
  ...
  __pyx_pybuffernd_Im2.rcbuffer = &__pyx_pybuffer_Im2;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Im1.rcbuffer->pybuffer, (PyObject*)__pyx_v_Im1, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 18, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Im2.rcbuffer->pybuffer, (PyObject*)__pyx_v_Im2, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 18, __pyx_L1_error)
  }
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_h); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_w); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 37, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_h); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_w); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_ascontiguousarray); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_n_s_np); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_h); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_w); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_c); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float64); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_ascontiguousarray); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_7))) {
  ...
  __pyx_t_11 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    __pyx_pybuffernd_Im1.diminfo[0].strides = __pyx_pybuffernd_Im1.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_Im1.diminfo[0].shape = __pyx_pybuffernd_Im1.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_Im1.diminfo[1].strides = __pyx_pybuffernd_Im1.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_Im1.diminfo[1].shape = __pyx_pybuffernd_Im1.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_Im1.diminfo[2].strides = __pyx_pybuffernd_Im1.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_Im1.diminfo[2].shape = __pyx_pybuffernd_Im1.rcbuffer->pybuffer.shape[2];
    if (unlikely(__pyx_t_12 < 0)) __PYX_ERR(0, 42, __pyx_L1_error)
  }
  __pyx_t_11 = 0;
  __Pyx_DECREF_SET(__pyx_v_Im1, ((PyArrayObject *)__pyx_t_1));
  __pyx_t_1 = 0;

  /* "optical_flow_warping.pyx":43
 *         np.ascontiguousarray(np.zeros((h, w, c), dtype=np.float64))
 *     Im1 = np.ascontiguousarray(Im1)
 *     Im2 = np.ascontiguousarray(Im2)             # <<<<<<<<<<<<<<
 * 
 *     warping_pyramid(&vx[0, 0], &vy[0, 0], &warpI2[0, 0, 0],
 */
  __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_n_s_np); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_ascontiguousarray); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_2))) {
...
static int __pyx_pymod_exec_optical_flow_warping(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_optical_flow_warping},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_optical_flow_warping, __pyx_k_optical_flow_warping, sizeof(__pyx_k_optical_flow_warping), 0, 0, 1, 1},
  {&__pyx_kp_s_optical_flow_warping_pyx, __pyx_k_optical_flow_warping_pyx, sizeof(__pyx_k_optical_flow_warping_pyx), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initoptical_flow_warping(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initoptical_flow_warping(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_optical_flow_warping(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_optical_flow_warping(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_optical_flow_warping(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'optical_flow_warping' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_optical_flow_warping(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("optical_flow_warping", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_optical_flow_warping) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "optical_flow_warping")) {
      if (unlikely(PyDict_SetItemString(modules, "optical_flow_warping", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                         double alpha=1, double ratio=0.5, int minWidth=40,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_20optical_flow_warping_1coarse2fine_flow, NULL, __pyx_n_s_optical_flow_warping); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_coarse2fine_flow, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "optical_flow_warping.pyx":1
 * # distutils: language = c++             # <<<<<<<<<<<<<<
 * # distutils: sources = source/warping_pyramid.cpp
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init optical_flow_warping", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init optical_flow_warping");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
